...
(function(){
  ...
  const VERSION = "2026-09-24-consolidated-v1.16";
  ...
  function init(){
    ...
    const stepNames = ["Room","Enclosure + Screen","Launch Monitor","Projector","Turf","Computer + Monitor","Accessories","Review"];
    ...
    try{
      ...
      if(saved && typeof saved==="object"){
        const needsLayoutMigration=saved.layoutVersion!==2;
        state={...state,...saved,layoutVersion:2};
        if(needsLayoutMigration){
          if(state.step===5) state.step=4;
          else if(state.step>=6) state.step=Math.min(state.step-1,7);
        }
      }
...
@media(max-width:560px){#tnsb-root .tnsb-radio-grid{grid-template-columns:1fr}#tnsb-root .tnsb-submit-area{align-items:stretch;flex-direction:column}#tnsb-root .tnsb-card h3{padding-right:0;margin-top:26px}#tnsb-root .tnsb-badge{left:12px;right:auto;max-width:calc(100% - 24px)}}
    ...
    ROOT.innerHTML=`
      <div class="tnsb-shell">
        ...
        <section class="tnsb-section" data-step="4">
          <div class="tnsb-kicker">STEP 5 OF 8</div><h2>Turf</h2>
          ...
          <div class="tnsb-btnrow"><button class="tnsb-btn" data-go="3">← Back</button><button class="tnsb-btn tnsb-primary" data-go="5">Computer + Monitor →</button></div>
        </section>

        <section class="tnsb-section" data-step="5">
          <div class="tnsb-kicker">STEP 6 OF 8</div><h2>Computer + Monitor</h2>
          ...
          <div class="tnsb-btnrow"><button class="tnsb-btn" data-go="4">← Back</button><button class="tnsb-btn tnsb-primary" data-go="6">Accessories →</button></div>
        </section>

        <section class="tnsb-section" data-step="6">
          <div class="tnsb-kicker">STEP 7 OF 8</div><h2>Accessories</h2>
          ...
          <div class="tnsb-btnrow"><button class="tnsb-btn" data-go="5">← Back</button><button class="tnsb-btn tnsb-primary" data-go="7">Review →</button></div>
        </section>

        <section class="tnsb-section" data-step="7">
          <div class="tnsb-kicker">STEP 8 OF 8</div><h2>Review + Request a Quote</h2>
          ...
          <div class="tnsb-btnrow"><button class="tnsb-btn" data-go="6">← Back</button><span></span></div>
        </section>
      </div>
    `;
    ...
    function goStep(index){
      state.step=clamp(Number(index)||0,0,7); save();
    ...
    function renderForStep(step){
      ...
      if(step===5){ renderComputers(); renderMonitors(); }
      if(step===6) renderAccessories();
    ...
    ["tnsb-room-w","tnsb-room-d","tnsb-room-h"].forEach((id,i)=>$(id).addEventListener("input",e=>{state[["roomW","roomD","roomH"][i]]=Number(e.target.value)||0;save();if(state.step===1)renderFront();if(state.step===4)renderFlooring();if(state.step===6)renderAccessories();updateTotals();}));
