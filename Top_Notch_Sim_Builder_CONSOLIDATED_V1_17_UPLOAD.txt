...
(function(){
  ...
  const VERSION = "2026-09-24-consolidated-v1.17";
    ...
    ROOT.innerHTML=`
      <div class="tnsb-shell">
        ...
        <section class="tnsb-section" data-step="3">
          ...
          <p class="tnsb-lead">Choose the projector, computer, and monitor together. The same compatibility rules remain in place: projector guidance follows the selected screen ratio, computer recommendations respond to the launch monitor and projector resolution, and monitor recommendations respond to the selected gaming tower.</p>

          <div class="tnsb-subsection" style="margin-top:0;padding-top:0;border-top:0"><h3>Projector</h3>
          ...
          <div class="tnsb-subsection"><h3>Computer</h3><div id="tnsb-computer-list" class="tnsb-choice-grid"></div></div>
